...
public class VelocityFlywheelCommand extends CommandBase{
    ...
    public void execute(){
        ...
        double RPM = (control.y + bbbDoubleUtils.clamp(control.x, -1, 1))* Constants.DynConfig.Flywheel.RPM;
        RPM = bbbDoubleUtils.clamp(RPM, -Constants.DynConfig.Flywheel.RPM, Constants.DynConfig.Flywheel.RPM);
        double targetUnitsPS = (RPM/600.0)*(Constants.Config.Flywheel.MotionControl.kSensorUnitsPerRotation);
