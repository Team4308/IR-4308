...
public class ToPowerPort1mr extends SequentialCommandGroup {
    ...
    public ToPowerPort1mr(TalonFXDriveSystem driveSystem, IntakeSystem intakeSystem, RollerSystem rollerSystem, HopperSystem hopperSystem, FlywheelSystem flywheelSystem) {
        addCommands(
            new DriveDistance(-1.3, driveSystem),
            new DriveTurn(-45, driveSystem),
            new DriveDistance(-Math.sqrt(2.0), driveSystem),
            new DriveTurn(45, driveSystem),
            new DriveDistance(-1.0, driveSystem),
